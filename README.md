...
```sh
git clone https://github.com/nickjj/docker-rails-example s7_08
cd s7_08
...
The app is named `s7_08` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "s7_08" and update a few Docker related resources.
